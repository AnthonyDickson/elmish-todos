...
let connectionString = "Data Source=src/LustreTodos/app.sqlite3"
let migrationsPath = "src/LustreTodos/migrations"
let scriptPrefix = "LustreTodos.migrations."
...
// (e.g. LustreTodos.migrations.001_create_todos.sql).
